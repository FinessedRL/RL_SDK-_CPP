...
public:
	...
	bool Listen();
	int32_t BindPort(int32_t PortNum, bool bUseNextAvailable);
};
...
public:
	...
	bool ReadTitleFile(class FString FileToRead, EOnlineFileType FileType);
...
public:
	...
	void RequestOnlineImages(struct FScriptDelegate FinishedCallback, bool bSupportSRGB, TArray<class FString>& URLs);
...
public:
	...
	void SendStandardHeaders(class FString ContentType, bool bCache);
	void HTTPError(int32_t ErrorNum, class FString Data);
	void SendHeaders();
	void AddHeader(class FString Header, bool bReplace);
	...
	void eventSendText(class FString Text, bool bNoCRLF);
	void Dump();
	...
	void ClearSubst();
	void Subst(class FString Variable, class FString Value, bool bClear);
...
public:
	...
	void QueryUser(class FString McpId, bool bShouldUpdateLastActive);
