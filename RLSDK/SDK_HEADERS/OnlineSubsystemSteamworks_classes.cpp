...
void UOnlineSubsystemSteamworks::ClearCaptureAvailabilityChangeDelegate(struct FScriptDelegate CaptureAvailabilityDelegate)
{
	static UFunction* uFnClearCaptureAvailabilityChangeDelegate = nullptr;

	if (!uFnClearCaptureAvailabilityChangeDelegate)
	{
		uFnClearCaptureAvailabilityChangeDelegate = UFunction::FindFunction("Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.ClearCaptureAvailabilityChangeDelegate");
	}

	UOnlineSubsystemSteamworks_execClearCaptureAvailabilityChangeDelegate_Params ClearCaptureAvailabilityChangeDelegate_Params;
...
void UOnlineSubsystemSteamworks::AddCaptureAvailabilityChangeDelegate(struct FScriptDelegate CaptureAvailabilityDelegate)
{
	static UFunction* uFnAddCaptureAvailabilityChangeDelegate = nullptr;

	if (!uFnAddCaptureAvailabilityChangeDelegate)
	{
		uFnAddCaptureAvailabilityChangeDelegate = UFunction::FindFunction("Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.AddCaptureAvailabilityChangeDelegate");
	}

	UOnlineSubsystemSteamworks_execAddCaptureAvailabilityChangeDelegate_Params AddCaptureAvailabilityChangeDelegate_Params;
...
void UOnlineSubsystemSteamworks::OnCaptureAvailabilityChange(bool bCaptureAllowed)
{
	static UFunction* uFnOnCaptureAvailabilityChange = nullptr;

	if (!uFnOnCaptureAvailabilityChange)
	{
		uFnOnCaptureAvailabilityChange = UFunction::FindFunction("Function OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.OnCaptureAvailabilityChange");
	}

	UOnlineSubsystemSteamworks_execOnCaptureAvailabilityChange_Params OnCaptureAvailabilityChange_Params;
...
void UOnlineSubsystemSteamworks::OpenStoreForItems(uint8_t LocalUserNum, TArray<class FString> Targets, struct FScriptDelegate OnStorePurchaseCompleteDelegate)
{
