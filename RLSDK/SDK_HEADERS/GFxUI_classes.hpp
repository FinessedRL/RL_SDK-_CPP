...
public:
	...
	void AS3AddEventListener(class FString Type, class UGFxObject* O, bool useCapture, int32_t listenerPriority, bool useWeakReference);
	...
	void AddEventListener(struct FName Type, struct FScriptDelegate Listener, bool useCapture, int32_t listenerPriority, bool useWeakReference);
