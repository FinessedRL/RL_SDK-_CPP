...
struct FUIPlayerBinding : FPlayerBinding
{
	...
	class FString                                      UIAxisKey;                                     // 0x0040 (0x0010) [0x0000000040400000] (CPF_NeedCtorLink | CPF_EditInlineNotify)
};
...
{
	TArray<struct FTeamUpdateState>                    Teams;                                         // 0x0000 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
...
struct FUpdateStateData
{
	...
	TArray<struct FPlayerUpdateState>                  Players;                                       // 0x0010 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
...
struct FAntiCheatMessage
{
	...
	TArray<class FString>                              MessageParts;                                  // 0x0008 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
