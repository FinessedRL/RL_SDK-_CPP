...
public:
	...
	bool ReadContentList(uint8_t PlayerNum, struct FUniqueNetId NetId, class FString Path, int32_t StartAt, int32_t NumToRead);
	void Exit();
	bool Init();
...
public:
	...
	struct FScriptDelegate                             __OnCaptureAvailabilityChange__Delegate;       // 0x1018 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	bool ShowDeviceSelectionUI(uint8_t LocalUserNum, int32_t SizeNeeded, bool bManageStorage);
	...
	bool ShowGamerCardUI(uint8_t LocalUserNum, struct FUniqueNetId UniqueId, class FString PlayerName);
...
public:
	...
	bool AppIdToName(class FString AppID, bool bOptional, struct FName& AppName);
	bool AppNameToId(struct FName AppName, bool bOptional, class FString& AppID);
};
...
// 0x0004 (0x0B60 - 0x0B64)
class USteamWorkshopEngine : public UGameEngine
{
public:
	uint32_t                                           bHasFinsihed : 1;                              // 0x0B60 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
