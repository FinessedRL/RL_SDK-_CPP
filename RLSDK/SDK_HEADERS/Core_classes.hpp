...
// Enum Core._Types_Generated.EContentKeyIndex_PrimeUpdate58
enum class EContentKeyIndex_PrimeUpdate58_1 : uint8_t
{
...
public:
	...
	struct FVector TransformVectorByRotation(struct FRotator SourceRotation, struct FVector SourceVector, bool bInverse);
	...
	bool LinePlaneIntersection(struct FVector LineStart, struct FVector LineEnd, struct FVector PlaneOrigin, struct FVector PlaneNormal, bool bCheckLineSegment, struct FVector& Out_Intersection, float& Out_T);
	...
	static class UObject* DynamicLoadObject(class FString ObjectName, class UClass* ObjectClass, bool MayFail);
	...
	bool IsInState(struct FName TestState, bool bTestStateStack);
	void GotoState(struct FName NewState, struct FName Label, bool bForceEvents, bool bKeepStack);
	static bool IsUTracing();
	static void SetUTracing(bool bShouldUTrace);
	static struct FName GetFuncName();
	static void DebugBreak(int32_t UserFlags, EDebugBreakType DebuggerType);
	...
	static class FString Localize(class FString SectionName, class FString KeyName, class FString PackageName, bool bOptional);
	static void WarnInternal(class FString S);
	static void LogInternal(class FString S, struct FName Tag, bool bFileOnly);
	...
	static struct FQuat QuatSlerp(struct FQuat A, struct FQuat B, float Alpha, bool bShortestPath);
	...
	static TArray<class FString> SplitString(class FString Source, class FString Delimiter, bool bCullEmpty);
	...
	static class FString JoinArrayQWord(class FString delim, bool bIgnoreBlanks, TArray<uint64_t>& QWordArray);
	static class FString JoinArrayInt(class FString delim, bool bIgnoreBlanks, TArray<int32_t>& IntArray);
	static class FString JoinArrayName(class FString delim, bool bIgnoreBlanks, TArray<struct FName>& NameArray);
	static class FString JoinArrayStr(class FString delim, bool bIgnoreBlanks, TArray<class FString>& StringArray);
	static void JoinArray(class FString delim, bool bIgnoreBlanks, TArray<class FString>& StringArray, class FString& out_Result);
	static class FString GetRightMost(class FString Text);
	static class FString Split(class FString Text, class FString SplitStr, bool bOmitSplitStr);
	...
	static class FString PadRight(class FString S, int32_t WidthChars);
	static bool StartsWith(class FString Src, class FString Prefix);
	static class FString Trim(class FString Src);
	static class FString Repl(class FString Src, class FString Match, class FString With, bool bCaseSensitive);
	...
	static int32_t InStr(class FString S, class FString T, bool bSearchFromRight, bool bIgnoreCase, int32_t StartPos);
	...
	static struct FRotator RInterpTo(struct FRotator Current, struct FRotator Target, float DeltaTime, float InterpSpeed, bool bConstantInterpSpeed);
	...
	bool InCylinder(struct FVector Origin, struct FRotator Dir, float Width, struct FVector A, bool bIgnoreZ);
	...
	static void SQWordMin();
	static void SQWordMax();
	static void SubtractEqual_SQWordSQWord();
	static void AddEqual_SQWordSQWord();
	static bool NotEqual_SQWordSQWord();
	static bool EqualEqual_SQWordSQWord();
	static bool GreaterEqual_SQWordSQWord();
	static bool LessEqual_SQWordSQWord();
	static bool Greater_SQWordSQWord();
	static bool Less_SQWordSQWord();
	static void Subtract_SQWordSQWord();
	static void Add_SQWordSQWord();
	static void Divide_SQWordSQWord();
	static void Multiply_SQWordSQWord();
...
public:
	...
	static void AllCDOs(class UClass* BaseClass, bool bIncludeAbstract, class UObject*& OutCDO);
...
{
public:
	uint8_t UnknownData00[0x68]; // 0x0060 (0x0068) DYNAMIC FIELD PADDING
	class UClass* PropertyClass; // 0x00C8 (0x0008)
	uint8_t UnknownData01[0x8]; // 0x00D0 (0x0008) DYNAMIC FIELD PADDING
...
public:
	...
	uint32_t                                           QuickChatTimeStamp : 1;                        // 0x0074 (0x0004) [0x0000000040000000] [0x20000000] (CPF_EditInlineNotify)
	uint32_t                                           SoccarPong : 1;                                // 0x0074 (0x0004) [0x0000000040000000] [0x40000000] (CPF_EditInlineNotify)
	uint32_t                                           OnlineFreeplay : 1;                            // 0x0074 (0x0004) [0x0000000040000000] [0x80000000] (CPF_EditInlineNotify)
	uint32_t                                           MatchmakingSubRegion : 1;                      // 0x0078 (0x0004) [0x0000000040000000] [0x00000002] (CPF_EditInlineNotify)
	uint32_t                                           CrossbarSFX : 1;                               // 0x0078 (0x0004) [0x0000000040000000] [0x00000004] (CPF_EditInlineNotify)
	uint32_t                                           RugbyIteration : 1;                            // 0x0078 (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	uint32_t                                           ChallengesV2 : 1;                              // 0x0078 (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
	uint32_t                                           PossessionExpanded : 1;                        // 0x0078 (0x0004) [0x0000000040000000] [0x00000040] (CPF_EditInlineNotify)
	uint32_t                                           TargetFind : 1;                                // 0x0078 (0x0004) [0x0000000040000000] [0x00000080] (CPF_EditInlineNotify)
	uint32_t                                           KeepUp : 1;                                    // 0x0078 (0x0004) [0x0000000040000000] [0x00000200] (CPF_EditInlineNotify)
	uint32_t                                           RocketPassUpgrades : 1;                        // 0x0078 (0x0004) [0x0000000040000000] [0x00000800] (CPF_EditInlineNotify)
	uint32_t                                           PentathlonTournaments : 1;                     // 0x0078 (0x0004) [0x0000000040000000] [0x00001000] (CPF_EditInlineNotify)
	uint32_t                                           DemolishUpdates : 1;                           // 0x0078 (0x0004) [0x0000000040000000] [0x00002000] (CPF_EditInlineNotify)
	uint32_t                                           ViralItem : 1;                                 // 0x0078 (0x0004) [0x0000000040000000] [0x00004000] (CPF_EditInlineNotify)
	uint32_t                                           ThankYouMessage : 1;                           // 0x0078 (0x0004) [0x0000000040000000] [0x00008000] (CPF_EditInlineNotify)
	uint32_t                                           AttackerDemoFX : 1;                            // 0x0078 (0x0004) [0x0000000040000000] [0x00010000] (CPF_EditInlineNotify)
	uint32_t                                           NewDriverChallengesV2 : 1;                     // 0x0078 (0x0004) [0x0000000040000000] [0x00020000] (CPF_EditInlineNotify)
	uint32_t                                           TextModeration : 1;                            // 0x0078 (0x0004) [0x0000000040000000] [0x00100000] (CPF_EditInlineNotify)
	uint32_t                                           FilterToggle : 1;                              // 0x0078 (0x0004) [0x0000000040000000] [0x00200000] (CPF_EditInlineNotify)
	uint32_t                                           DdosPrevention : 1;                            // 0x0078 (0x0004) [0x0000000040000000] [0x00400000] (CPF_EditInlineNotify)
	uint32_t                                           OunceEnhancements : 1;                         // 0x0078 (0x0004) [0x0000000040000000] [0x00800000] (CPF_EditInlineNotify)
	uint32_t                                           FastFreeplay : 1;                              // 0x0078 (0x0004) [0x0000000040000000] [0x01000000] (CPF_EditInlineNotify)
	uint32_t                                           MatchAdminMutator : 1;                         // 0x0078 (0x0004) [0x0000000040000000] [0x02000000] (CPF_EditInlineNotify)
