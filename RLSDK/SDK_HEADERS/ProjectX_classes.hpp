...
public:
	...
	void eventProcessHit(class AActor* Victim, struct FVector HitLocation, float DeltaTime, float DamageScale, struct FContactInformation& ContactInfo);
};
...
public:
	...
	void SetCameraFade(bool bNewEnableFading, struct FColor NewFadeColor, struct FVector2D NewFadeAlpha, float NewFadeTime, bool bNewFadeAudio);
...
public:
	...
	static bool ParseCommandlineString(class FString Param, bool bShouldStopOnComma, class FString& OutValue);
...
public:
	...
	EFeaturePrivilegeLevel CanCommunicateVoice(bool bTryToResolve);
	EFeaturePrivilegeLevel CanCommunicateText(bool bTryToResolve);
	void OpenErrorDialog(EPS4ErrorDialog ErrorCode);
	void OpenPS4DisplayMode(EPS4DisplayMode DisplayMode, TArray<class FString> Targets, int32_t ServiceLabel);
	...
	void HideKeyboard();
	bool ShowKeyboard(class FString TitleText, class FString DescriptionText, bool bIsPassword, class FString DefaultText, int32_t MaxLength, struct FScriptDelegate OnCompleteDelegate, int32_t LocalPlayerNumOverride);
	void OnNewGame();
...
public:
	...
	void HandleAccountSummaryResponse(class UEOS_AccountSummaryResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams);
	void HandleGetOutgoingInvitesResponse(class UEOS_GetAccountsResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams);
	void HandleGetIncomingInvitesResponse(class UEOS_GetAccountsResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams);
	void HandleGetBlockListResponse(class UEOS_GetAccountsResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams);
	void HandleUnblockPlayerResponse(class UEOS_ManageBlockListResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams);
	void HandleBlockPlayerResponse(class UEOS_ManageBlockListResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams);
	void HandleRejectFriendRequestResponse(class UEOS_ManageFriendsListResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams, class FString& FriendId);
	void HandleAcceptFriendRequestResponse(class UEOS_ManageFriendsListResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams, class FString& FriendId);
	void HandleRemoveFriendResponse(class UEOS_ManageFriendsListResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams, class FString& FriendId);
	void HandleAddFriendResponse(class UEOS_ManageFriendsListResponse* Response, class UError* Error, TArray<struct FHTTPRequestCapturedParam> CapturedParams, class FString& FriendId);
...
public:
	...
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	int32_t GetGameSettingIndex(struct FName SettingName, bool bIgnoreHidden);
...
public:
	...
	void NotifyConnectionError(EProgressMessageType MessageType, class FString Message, class FString Title);
	void eventSetProgressMessage(EProgressMessageType MessageType, class FString Message, class FString Title, bool bIgnoreFutureNetworkMessages);
...
public:
	...
	void RequestGarbageCollection(EGFxCollectionMode Mode, bool bImmediate);
	void PrintDebugInfo(class UDebugDrawer* Drawer);
...
public:
	...
	void InitDataHooks();
	void eventOnClose();
	bool eventStart(bool StartPaused);
...
public:
	...
	class FString GetRelativeUrl(bool bUseAppendedPath);
...
public:
	...
	static class FString GetBeaconExternalHostAddress(bool bWithPort);
	static class FString GetBeaconLocalHostAddress(bool bWithPort);
	static int32_t GetUdpPort();
	static class FString GetUdpExternalHostAddress(bool bWithPort);
	static class FString GetUdpLocalHostAddress(bool bWithPort);
	void HandleInternetConnectionChanged(bool bConnected);
...
public:
	...
	void GetPlayerAvatar(struct FUniqueNetId PlayerID, struct FScriptDelegate ReadOnlineAvatarCompleteDelegate, EAvatarSize Size);
	void GetPlayerAvatars(struct FScriptDelegate ReadOnlineAvatarCompleteDelegate, EAvatarSize Size, TArray<struct FUniqueNetId>& PlayerIds);
...
public:
	...
	struct FName GetNextMapName(int32_t GameMode, bool bStandardOnly, bool bRocketLabsMedleyOnly);
...
public:
	...
	static bool AssignTeams(int32_t TeamSize, bool bKeepTeams, TArray<struct FReservationData>& TestPlayers);
	...
	struct FReservationData CreateReservationData(struct FUniqueNetId PlayerID, class FString PlayerName, struct FUniqueNetId PartyID, EReservationStatus Status);
...
public:
	...
	void PauseTimer(bool bPause, struct FName inTimerFunc, class UObject* inObj);
...
public:
	...
	static void SetStateTimer(struct FScriptDelegate Callback, float Rate, bool bLoop);
	static void Set(struct FScriptDelegate Callback, float Rate, bool bLoop);
...
public:
	...
	void SetStateTimer(struct FScriptDelegate Callback, float Rate, bool bLoop);
	void Set(struct FScriptDelegate Callback, float Rate, bool bLoop);
};
...
public:
	...
	void SetActiveChildNamed(struct FName ChildName, bool bForce);
	float GetAnimDuration(int32_t ChildIndex);
	float GetBlendTime(int32_t ChildIndex, bool bGetDefault);
};
...
public:
	...
	void OnPartyChanged(EPartyProcessingStatus NewProcessingStatus);
...
public:
	...
	void OnJoinGameComplete(bool bSuccess, class FString FailReason);
...
public:
	...
	bool FindLobbies(int32_t MaxResults, TArray<struct FLobbyFilter> Filters, TArray<struct FLobbySortFilter> SortFilters, int32_t MinSlots, ELobbyDistance Distance);
	bool CreateLobby(int32_t LocalPlayerNum, int32_t MaxPlayers, ELobbyVisibility Type, TArray<struct FLobbyMetaData> InitialSettings);
...
public:
	...
	bool StartWordFilterTask(EWordFilterUsage Usage, class FString Comment, struct FScriptDelegate SanitizeDelegate, struct FUniqueNetId PlayerID);
	...
	class FString Sanitize(EWordFilterUsage Usage, class FString Comment, struct FScriptDelegate Callback, struct FScriptDelegate ErrorCallback, struct FUniqueNetId PlayerID);
	class FString SanitizePlayerName(EOnlinePlatform PlayerPlatform, class FString PlayerName, struct FScriptDelegate Callback, struct FScriptDelegate ErrorCallback, struct FUniqueNetId PlayerID);
	void OnMainMenuOpened();
};
...
public:
	...
	void SendFriendInvite(struct FUniqueNetId ReceiverPlayerID, uint64_t TimeStamp);
	void RejectFriendInvite(struct FUniqueNetId SenderPlayerID, uint64_t TimeStamp);
	void AcceptFriendInvite(struct FUniqueNetId SenderPlayerID, uint64_t TimeStamp);
...
public:
	...
	class UAsyncTask* CreateParty(int32_t LocalPlayerNum, int32_t MaxPlayers, ELobbyVisibility Type, TArray<struct FLobbyMetaData> InitialSettings);
...
public:
	...
	bool WordFilterSanitizeString(EWordFilterUsage Usage, class FString Comment, struct FScriptDelegate SanitizeDelegate, struct FUniqueNetId PlayerID);
...
public:
	...
	void RecordFoundServer(bool bFromNotification, struct FGuid MatchMakingGuid, bool bDisableCrossPlay, float MMR, int32_t Tier, struct FServerReservationData& Reservation);
...
public:
	...
	void ClubIntroShown(uint64_t FirstClubID, uint64_t SecondClubID, class FString MatchGUID, uint64_t TimeStamp);
	class FString GetRoleString(EClubRole ClubRole);
	void ChangePlayerRole(uint64_t ClubID, struct FUniqueNetId MemberPlayerID, class FString OriginalRole, class FString NewRole, uint64_t TimeStamp);
	void HandleRoleChanged(uint64_t ClubID, struct FUniqueNetId MemberPlayerID, EClubRole OriginalRole, EClubRole NewRole);
	void SendClubInvite(uint64_t ClubID, struct FUniqueNetId ReceiverPlayerID, uint64_t TimeStamp);
	void RejectClubInvite(uint64_t ClubID, struct FUniqueNetId SenderPlayerID, uint64_t TimeStamp);
	void AcceptClubInvite(uint64_t ClubID, struct FUniqueNetId SenderPlayerID, uint64_t TimeStamp);
	void HandleClubInviteEvent(uint64_t ClubID, struct FUniqueNetId PlayerID, EClubInviteEventType InviteEventType);
	void LeaveClub(uint64_t ClubID, uint64_t TimeStamp);
	void KickPlayer(uint64_t ClubID, struct FUniqueNetId KickedPlayerID, uint64_t TimeStamp);
};
...
public:
	...
	class UWebRequest_X* CreateDDoSServiceWebRequest(class FString ServicePort, class FString GamePort, TArray<class FString> ClientIPs, class FString DedicatedServerInstanceId, bool bEnabled, bool bSendPlayerIps);
	...
	bool EndDDoSService(class FString ServicePort, class FString GamePort, class FString DedicatedServerInstanceId, bool bSendPlayerIps);
...
public:
	...
	void OnGameInviteComplete(bool bSuccess, class FString FailReason);
...
public:
	...
	void Reset();
	void Report(struct FUniqueNetId PlayerID, EExploitType Reason, class FString Data);
...
public:
	...
	static void Send(struct FUniqueNetId InPlayerID, EExploitType InReason, class FString InMatchGUID, class FString InData);
};
