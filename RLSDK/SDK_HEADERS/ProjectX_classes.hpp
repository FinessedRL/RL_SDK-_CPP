...
public:
	...
	struct FScriptDelegate                             __OnHostStartPlayTogether__Delegate;           // 0x03A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void HandleSignedLobbyMessageFailed(class URPC_SignedPartyChat_X* RPC);
